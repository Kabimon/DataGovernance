...
public class AtlasClient extends AtlasClientV2 {
    ...
    public static class API_V3 extends API {
        public static final AtlasClient.API_V3 GET_ENTITIES = new AtlasClient.API_V3(ENTITIES_API, HttpMethod.GET, Response.Status.OK);
        public static final AtlasClient.API_V3 UPDATE_ENTITY_ATTR  = new AtlasClient.API_V3(UPDATE_ENTITY_ATTR_API,HttpMethod.PUT,Response.Status.OK);
